...
aggregate_cd <- ggplot(world_cd, aes(x=year, y=avg)) + geom_point() + geom_line(size = 1.25) + labs(title = "Change in Aggregate World Currency Demand 2001-2018", subtitle = "Significant Positive Trend", x= "Year", y = "Average Currency Demand", caption = "Source: IMF - International Financial Statistics; BoE; SNB; RBI; BCRA; MAS") 
print(aggregate_cd)
